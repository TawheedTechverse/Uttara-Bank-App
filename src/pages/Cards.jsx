  ...
  return (
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        ...
        <motion.div style={styles.cardBox} whileHover={{ scale: 1.03, y: -5 }}>
        ...
        <div style={styles.buttonRow}>
          <motion.button style={styles.walletButton} onClick={handleAddToWallet} whileHover={{ scale: 1.05, y: -3 }}>
            Add to Wallet
          </motion.button>
        </div>
        ...
        <AnimatePresence>
          {showSuccess && (
            <motion.div style={styles.popupOverlay} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              <motion.div style={styles.popup} initial={{ scale: 0.8 }} animate={{ scale: 1 }} exit={{ scale: 0.85 }}>
                <div style={styles.checkCircle}>✓</div>
                <h3 style={styles.popupTitle}>Success</h3>
                <p style={styles.popupText}>Your card has been added to your wallet successfully.</p>
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
...
const styles = {
  ...
  buttonRow: { display: "flex", justifyContent: "center", marginTop: "28px" },
  walletButton: {
    border: "none",
    borderRadius: "16px",
    padding: "16px 28px",
  ...
  popupTitle: { margin: "0 0 10px 0", color: "var(--text)", fontSize: "24px" },
  popupText: { margin: 0, color: "var(--muted)", lineHeight: 1.6 },
};